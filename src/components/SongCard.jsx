  ...
  return (
    <div className='flex flex-col w-[250px] p-4 bg-white/5 bg-opacity-80 backdrop-blur-sm animate-slideup rounded-lg cursor-pointer'>
      <div className='relative w-full h-56 group'>
        <div className={`absolute inset-0 bg-black bg-opacity-50 group-hover:flex justify-center items-center ${activeSong?.title === song.title ? 'flex bg-black bg-opacity-70' : 'hidden'}`}>
